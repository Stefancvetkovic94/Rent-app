...
const appRoutes: Routes = [
  ...
  { path: 'services/:id/edit-branch/:branchid', component: EditBranchComponent },
  ...
  { path: 'services/:id/edit-vehicle/:vehicleid', component: EditVehicleComponent},   //Service/EditVehicle 
